...
class UserDeletedArticleLinkSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        for ($i=1; $i <= $writersCount; $i++) {            
            $objWriter = User::create([
                'name' => 'writer-With-Deleted-Articles-Name' . $i,
                'surname' => 'writer-With-Deleted-Articles-Surname' . $i,
                'nickname' => 'writer-With-Deleted-Articles-Nickname' . $i,
                'role' => 'writer',
                'status' => 'active',
                'rubrics_combination_id' => rand(1, 256),
                'email' => 'writer-With-Deleted-Articles-' . $i . '@gmail.com',
