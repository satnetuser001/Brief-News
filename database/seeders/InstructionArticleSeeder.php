    ...
    public function run(): void
    {
        Article::create(['user_id' => 2,
                        ...
                        'body' => "Brief News -  веб-приложение новостей в кратком и беспристрастном изложении со ссылками на источники.
                                    ...
                                    Каждая статья принадлежит к одной или нескольким рубрикам (Политика, Экономика, Наука, Технологии, Спорт, Остальные) и локали (Мировые, Локальные).
                                    При помощи \"Панели сортировки статей по рубрикам и локали\" можно отобразить только интересующие пользователя статьи, например: Наука и Технологи в Мире.
